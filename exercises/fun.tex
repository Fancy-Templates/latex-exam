...
\begin{tasks}
   ...
   \VerticalSpace
   \task{2.5} Diese Teilaufgabe hat nur zwei-ein-halb Punkte. Der Text kann beliebig lang sein. Hier geben wir den Studierenden vier Antwortmöglichkeiten, von denen eine richtig ist:
   \begin{radioboxes}
   ...
   \begin{checkboxes}
      ...
      \item Antwortmöglichkeit 4
   \end{checkboxes}
   \task{0} Diese Aufgabe gibt zwar keine Punkte, wir erwarten von den Studierenden aber trotzdem eine Antwort:
