...
\begin{document}
   ...
   \end{Exercise}
   \begin{Exercise}[10]{A}\end{Exercise}
   \begin{Exercise}[10]{B}\end{Exercise}
   \begin{Exercise}[10]{C}\end{Exercise}
   \begin{Exercise}[10]{D}\end{Exercise}
   \begin{Exercise}[10]{E}\end{Exercise}
   \appendix
   Bar
\end{document}